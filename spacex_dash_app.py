...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        fig = px.pie(filtered_df, 
            values = list(filtered_df['class'].value_counts()),
            #names= filtered_df['class'].value_counts().index.tolist(),
            names = ['Fail','Success'],
            #title='Total Success Launches By Selected Site'
            #title = 'CCAFS LC-40'
            title = "Success/Fail Rate for " + entered_site
        )
        return fig
